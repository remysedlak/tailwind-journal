  ...
  return (
    <div className="flex flex-col h-screen justify-around items-center p-2 m-2">
      ...
      <div className="flex flex-row justify-around lg:text-6xl text-4xl" >
        <h1 className="text-orange-600 motion-preset-wobble ">journal</h1>
        <h1 className="text-red-600">logger</h1>
      </div>
      {/* directions */}
        <ul className="bg-orange-50 p-2 gap-y-6 border flex flex-col text-center justify-around rounded text-xl">
